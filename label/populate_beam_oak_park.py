...
# Run with:  python3 -m label.populate_oak_park_profile
if __name__ == '__main__':
    data_dict = {
        'street': '1150 Holley Court', 'city': 'Oak Park', 'state': 'IL', 'zipcode': '60302', 
        'year_built': 	1984, 'year_ending': 2023, 'propGrossFloorArea': 323965.0, 'systemDefinedPropertyType': 'Garage', 'energy_star_score': 99, 'site_total': 3434,  'medianSiteIntensity': 2500, 'percentBetterThanSiteIntensityMedian': 0.25, 'cons_mmbtu_min': 0,
