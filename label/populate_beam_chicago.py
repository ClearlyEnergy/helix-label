# -*- coding: utf-8 -*-
#! /usr/bin/python
# run with python3 -m label.populate_beam_chicago
...
CUSTOM_DTEAL = colors.Color(red=(0/255),green=(117/255),blue=(187/255))
...
def write_chicago_profile_pdf(data_dict, output_pdf_path):
    ...
    vthep_logo = IMG_PATH+"/chicago.png"
    im = Image(vthep_logo, 1.1*inch, 1.1*inch) #max is 1.1 inch height
    Story.append(im)
    ...
    text_c101, text_c102, text_c103 = Highlights.score_box(data_dict, 'GHG')
    ...
    Story.append(Paragraph('<font name="InterstateLight" color=blue><u><link href="https://www.chicago.gov/city/en.html">Contact us</link></u></font> for personalized technical assistance from a dedicated account manager', pc291, bulletText=UNCHECKED.encode('UTF8')))
    Story.append(Paragraph('Access <font name="InterstateLight" color=blue><u><link href="https://www.chicago.gov/city/en.html">free trainings</link></u></font>on building decarbonization strategies, and compliance', pc291, bulletText=UNCHECKED.encode('UTF8')))
    Story.append(Paragraph('Find <font name="InterstateLight" color=blue><u><link href="https://www.chicago.gov/city/en.html">financing options</link></u></font> for energy efficiency, electrification, and clean energy projects', pc291, bulletText=UNCHECKED.encode('UTF8')))
    Story.append(Paragraph('Get started with the <font name="InterstateLight" color=blue><u><link href="https://www.chicago.gov/city/en.html">BEAM Optimizer</link></u></font> to visualize your path to LL97 compliance based on the timing of investments, budget', pc291, bulletText=UNCHECKED.encode('UTF8')))
    Story.append(Paragraph('Attend an <font name="InterstateLight" color=blue><u><link href="https://www.chicago.gov/city/en.html"> upcoming event</link></u></font>.', pc291, bulletText=UNCHECKED.encode('UTF8')))
...
if __name__ == '__main__':
    data_dict = {
        'street': '20 S WACKER DR', 'city': 'CHICAGO', 'state': 'IL', 'zipcode': '606061', 
        'year_built': 1950, 'year_ending': 2024, 'propGrossFloorArea': 100000.0, 'systemDefinedPropertyType': 'Office', 'energy_star_score': 99, 'site_total': 3434,  'medianSiteIntensity': 2500, 'percentBetterThanSiteIntensityMedian': 0.25, 'cons_mmbtu_min': 0,
        'siteEnergyUseElectricityGridPurchase': 1000.0, 'siteEnergyUseElectricityGridPurchaseKwh': 100000.0, 'siteEnergyUseNaturalGas': 1000.0, 'siteEnergyUseKerosene': 0.0, 'siteEnergyUsePropane': 0.0,
        ...
        'energyCostElectricityGridPurchase': 6000.0, 'energyCostNaturalGas': 4000.0, 'energyCostKerosene': 0.0, 'energyCostPropane': 0000.0,
        ...
        'totalLocationBasedGHGEmissions': 1500,
    ...
    out_file = 'Chicago_Profile.pdf'
    write_chicago_profile_pdf(data_dict, out_file)