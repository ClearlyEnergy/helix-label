...
CUSTOM_DTEAL = colors.Color(red=(43.0/255),green=(90.0/255),blue=(107.0/255))
...
def write_providence_profile_pdf(data_dict, output_pdf_path):
    ...
    vthep_logo = IMG_PATH+"/city_of_providence_logo.png"
    im = Image(vthep_logo, 1.0*inch, 1.0*inch)
    Story.append(im)
...
if __name__ == '__main__':
    ...
    out_file = 'Providence_Profile.pdf'
    write_providence_profile_pdf(data_dict, out_file)