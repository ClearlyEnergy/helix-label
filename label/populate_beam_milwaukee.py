...
CUSTOM_DTEAL = colors.Color(red=(108.0/255),green=(165.0/255),blue=(172.0/255))
...
def write_milwaukee_profile_pdf(data_dict, output_pdf_path):
    ...
    vthep_logo = IMG_PATH+"/milwaukee.png"
    im = Image(vthep_logo, 1.419*inch, 1.1*inch) #max is 1.1 inch height
    Story.append(im)
...
# Run with:  python3 -m label.populate_beam_milwaukee
if __name__ == '__main__':
    has_cost = False
    if has_cost:
        data_dict = {
            'street': '77 MASSACHUSETTS AVE', 'city': 'CAMBRIGE', 'state': 'MA', 'zipcode': '02139', 
            'year_built': 1895, 'year_ending': 2024, 'propGrossFloorArea': 100000.0, 'systemDefinedPropertyType': 'Hotel', 'energy_star_score': 99, 'site_total': 3434,  'medianSiteIntensity': 2500, 'percentBetterThanSiteIntensityMedian': 0.25, 'cons_mmbtu_min': 0,
...
#no costs data example
        ...
        data_dict = {
            'street': '200 E WELLS ST', 'city': 'MILWAUKEE', 'state': 'WI', 'zipcode': '53202', 
            'year_built': 1895, 'year_ending': 2024, 'propGrossFloorArea': 100000.0, 'systemDefinedPropertyType': 'Office', 'energy_star_score': 99, 'site_total': 3434,  'medianSiteIntensity': 2500, 'percentBetterThanSiteIntensityMedian': 0.25, 'cons_mmbtu_min': 0,
    ...
    out_file = 'Milwaukee_Profile.pdf'
    write_milwaukee_profile_pdf(data_dict, out_file)