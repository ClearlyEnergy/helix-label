...
def footer(canvas,doc):
    ...
    # Header
    footer = Paragraph('Home Owner | ' + data_dict['address_line_1'] + data_dict['address_line_2'] + ', ' + data_dict['city'] + ', '+ data_dict['state'] + data_dict['postal_code']  + 'Brought to you by', styles['Normal'])
...
def create_pdf(data_dict, out_file):
    ...
    document = SimpleDocTemplate(out_file,pagesize=landscape(letter),rightMargin=20,leftMargin=20,topMargin=20,bottomMargin=20)
    styles = getSampleStyleSheet()
