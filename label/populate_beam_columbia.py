# -*- coding: utf-8 -*-
#! /usr/bin/python
# run with python3 -m label.populate_beam_columbia
...
CUSTOM_DTEAL = colors.Color(red=(67.0/255),green=(166.0/255),blue=(223.0/255)) ## This is the color to customize
...
def write_columbia_profile_pdf(data_dict, output_pdf_path):
#    is_data_valid, msg, data_dict = validate_data_dict(data_dict)
    ...
    vthep_logo = IMG_PATH+"/columbia_logo.png"
    im = Image(vthep_logo, 1.5*inch, 0.87*inch)
    Story.append(im)
    ...
    Story.append(Paragraph("This energy profile details the estimated annual energy costs and expected annual energy usage of this City of Columbia building. It highlights site specific information and trends in energy usage compared to other buildings of this type.", tf_standard))
...
### BUILD PAGE
    page_1_frames = [column_10, column_11, column_12, column_211, column_212, column_22, column_231, column_232, column_24, column_251, column_252, column_253, column_261, column_27]
    templates =[]
