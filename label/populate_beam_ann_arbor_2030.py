...
def write_ann_arbor_2030_profile_pdf(data_dict, output_pdf_path):
    ...
    Story.append(Paragraph('ENROLL in <font name="InterstateLight" color=blue><u><link href="https://solutions.dteenergy.com/dte/en/Products/DTE-CleanVision-MIGreenPower/p/MIGPGREEN">DTE’s Renewable Energy Program</link></u></font> MIGREENPOWER for +$0.01387/kWh', pc291, bulletText=UNCHECKED.encode('UTF8')))
...
# Run with:  python3 -m label.populate_beam_ann_arbor_2030_profile
