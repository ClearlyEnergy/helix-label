...
#    is_data_valid, msg, data_dict = validate_data_dict(data_dict)
    ...
    Story.append(Paragraph('For information about solar energy options please <font name="InterstateLight" color=blue><link href="https://www.indy.gov/activity/solar-energy">Indy Solar Energy</link></font>.', pc291, bulletText=UNCHECKED.encode('UTF8')))
    Story.append(Paragraph('For energy efficiency building tune ups please view the following <font name="InterstateLight" color=blue><link href="https://www.aesindiana.com/your-business">Retrocomissioning</link></font> and <font name="InterstateLight" color=blue><link href="https://www.aesindiana.com/retro-commissioning">Ways to Save</link></font>. ', pc291, bulletText=UNCHECKED.encode('UTF8')))
    Story.append(Paragraph('For information regarding financing building tune ups please <font name="InterstateLight" color=blue><link href="https://www.energy.gov/eere/buildings/find-financing-energy-efficiency-upgrades">visit this page</link></font>.', pc291, bulletText=UNCHECKED.encode('UTF8')))
    Story.append(Paragraph('For schools looking for funding a building tune up please <font name="InterstateLight" color=blue><link href="https://www.energy.gov/eere/buildings/financing-efficient-and-healthy-retrofits">visit this page</link></font>.', pc291, bulletText=UNCHECKED.encode('UTF8')))    
    Story.append(Paragraph('For a list of Energy Star service providers who can perform building tune ups please visit <font name="InterstateLight" color=blue><link href="https://www.energystar.gov/buildings/save_energy_commercial_buildings/expert_help/find_spp">Tips for Finding an SPP</link></font>.', pc291, bulletText=UNCHECKED.encode('UTF8')))    
