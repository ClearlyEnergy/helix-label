...
#    unchecked = u"\u2610"
    ...
    text_left_13b = Paragraph(datetime.datetime.now().strftime("%Y-%m-%d"),p6)
...
#        ('INNERGRID', (-2, -3), (-1, -1), 1, CUSTOM_LGREEN),
    ...
    if data_dict["evt"] or data_dict["estar_wh"] or data_dict["hers_score"]:
...
if __name__ == '__main__':
    data_dict = {'street': '123 Main St', 'city': 'Montpelier', 'state': 'VT', 'zipcode': '05000', 
        ...
        'evt': '', 'hers_score': None, 'estar_wh': False, 'author_name': 'John Doe'}
