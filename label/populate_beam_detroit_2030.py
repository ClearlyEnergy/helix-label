...
def write_detroit_2030_profile_pdf(data_dict, output_pdf_path):
    ...
    Story.append(Paragraph('SCHEDULE a review with 2030 District Energy Advisor <font name="InterstateLight" color=blue><u><link href="mailto:kkuneman@2030districts.org">here</link></u></font>', pc291, bulletText=UNCHECKED.encode('UTF8')))
    ...
    Story.append(Paragraph('Apply for free energy audits: <font name="InterstateLight" color=blue><u><link href="https://iac.msu.edu/">RESTART @ LTU, MSU IAC</link></u></font>', pc291, bulletText=UNCHECKED.encode('UTF8')))
    ...
    Story.append(Paragraph('Access financial assistance: <font name="InterstateLight" color=blue><u><link href="https://leanandgreenmi.com/">Michigan Saves</link></u></font> & <font name="InterstateLight" color=blue><u><link href="https://leanandgreenmi.com/">PACE</link></u></font>', pc291, bulletText=UNCHECKED.encode('UTF8')))
    Story.append(Paragraph("Explore the City of Detroit's" + '<font name="InterstateLight" color=blue><u><link href="https://detroitmi.gov/government/mayors-office/office-sustainability/energy-and-water-benchmarking-ordinance"> Energy and Water Benchmarking Ordinance</link></u></font>', pc291, bulletText=UNCHECKED.encode('UTF8')))
