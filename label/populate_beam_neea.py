# -*- coding: utf-8 -*-
#! /usr/bin/python
# run with python3 -m label.populate_beam_neea
...
CUSTOM_DTEAL = colors.Color(red=(51.0/255),green=(153.0/255),blue=(255.0/255))
...
def write_neea_profile_pdf(data_dict, output_pdf_path):
    ...
    vthep_logo = IMG_PATH+"/NEEA-logo.png"
    im = Image(vthep_logo, 1.573*inch, 1.1*inch) #max is 1.1 inch height
    Story.append(im)
...
if __name__ == '__main__':
    ...
    if has_cost:
        data_dict = {
            'street': '700 NE MULTNOMAH ST', 'city': 'PORTLAND', 'state': 'OR', 'zipcode': '97232', 
...
#no costs data example
    ...
    out_file = 'NEEA_Profile.pdf'
    write_neea_profile_pdf(data_dict, out_file)